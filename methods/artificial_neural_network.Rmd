...
library(reshape2)
library(ggplot2)
input.mat.ann.conventional = as.matrix(tv)

normalized.mat.ann.conventional = sweep(input.mat.ann.conventional, 2, colSums(input.mat.ann.conventional), "/" )
melt.mat.ann.conventional = melt(normalized.mat.ann.conventional)
ggplot(data = melt.mat.ann.conventional , aes(x=Var1, y=Var2, fill=value)) + 
  geom_tile() + ggtitle("Confusion Matrix of Artificial Neural Network") +
