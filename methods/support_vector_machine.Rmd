...
library(reshape2)
library(e1071)
svm_conventional <-svm(asLabel ~ Genre+Budget+Screens+Sequel+Gross, data = train,kernel = "linear")
...
library(reshape2)
library(e1071)
svm_social_media <-svm(asLabel ~ Aggregate.Followers+Sentiment+Views+Likes+Dislikes+Comments, data = train,kernel = "linear")
...
input.mat.test_social_media = as.matrix(cfm_svm_social_media)
