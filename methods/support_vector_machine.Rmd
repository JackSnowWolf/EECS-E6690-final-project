...
library(reshape2)
library(e1071)
svm_conventional <-svm(asLabel ~ Genre+Budget+Screens+Sequel+Gross, data = train,kernel = "polynomial",gemma = 0.9, coef0 = 3, degree = 4) ## hyperplane
...
library(reshape2)
library(e1071)
svm_social_media <-svm(asLabel ~ Aggregate.Followers+Sentiment+Views+Likes+Dislikes+Comments, data = train,kernel = "polynomial",coef0 = 4) ### hyperplane
