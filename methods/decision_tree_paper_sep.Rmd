...
library(rpart)
library(rpart.plot)
pretty_tree1=rpart(asLabel~.-Ratings,data=conventional_train.df,cp=0.001)
rpart.plot(pretty_tree1,box.palette = "RdBu",shadow.col = "gray",nn=TRUE)
```
## 2
```{r}
pretty_tree2=rpart(asLabel~.-Ratings,data=socialmedia_train.df,cp=0.001)
...
PredTreeScore1 = data.frame(predict(ctt1,conventional_train.df,type="vector"))
train1 = data.frame(conventional_train.df,PredLabel1,PredTreeScore1)

## valid
PredLabelValid1 = predict(ctt1,valid,type="class")
PredTreeScoreValid1 = data.frame(predict(ctt1,conventional_test.df,type="vector"))
...
PredTreeScore2 = data.frame(predict(ctt2,socialmedia_train.df,type="vector"))
...
PredTreeScoreValid2 = data.frame(predict(ctt2,socialmedia_test.df,type="vector"))
